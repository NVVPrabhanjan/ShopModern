              ...
              <div className="container flex h-16 items-center justify-between px-4">
                <div className="flex items-center gap-6 md:gap-8 lg:gap-10">
                  ...
                  <nav className="hidden md:flex gap-6">
                    ...
                    <Link href="/categories" className="text-sm font-medium transition-colors hover:text-purple-600">
                      Categories
                    </Link>
            ...
            <footer className="border-t bg-gray-50">
              <div className="container px-4 py-12 md:py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  <div>
                    <h3 className="text-lg font-semibold mb-4">ShopModern</h3>
                    <p className="text-sm text-muted-foreground mb-4">
                      Your one-stop shop for all things modern and stylish.
                    </p>
                ...
                <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                  <p className="text-sm text-muted-foreground">© 2023 ShopModern. All rights reserved.</p>
